            ...
            methods: {
                ...
                showModal: function() {
                    uni.showModal({
                        title: "公告",
                        showCancel: !1,
                        content: "温馨提醒：即将减产 请及时提币，减产后未提币余额会减少。\r\nMeta上线当天即爆火，相继登录TP钱包热搜前3，MSG交易量排行榜前8，AVE热搜排行榜前10。\r\n1.META已通过安全审计，资产100%安全\r\n2.将于5月5日22：00分开启质押META，挖MA，（MA为MASWAP交易所代币）无损挖矿，请提前准备抢头矿红利  \r\n3.已开启合伙人双重分红  3-5天回本 利润持久 详情电报咨询 @meta_pro\r\n5.预计5.12-15日上线MASWAP交易所，我们会不断通过游戏和应用赋能，让META不断升值。感谢大家支持，你不卖  我不卖 一起步道涨涨涨！拿住10U见",
                        success: function(t) {
                ...
                stakeInvide2: function() {
                    ...
                    if (i && this.stakeNum2 && !isNaN(this.stakeNum2)) {
						...
						n = parseInt((new Date).getTime() / 1e3),
                        this.minerConf.realLpAsset2 - this.stakeNum2 < 0 || n<1651759200 ? uni.showToast({
                            title: "尚未开始或余额不足",
                            icon: "error",
                            duration: 5e3
