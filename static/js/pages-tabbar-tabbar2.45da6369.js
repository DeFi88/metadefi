            ...
            methods: {
                ...
                initMiner: function() {
                    ...
                    o && !this.minerConf.doing && o.methods.getData(this.address).call().then((function(e) {
                        ...
                        t.minerConf.realFistAsset = new f.default(t.minerConf.fistAsset).dividedBy(Math.pow(10, g)).toFixed(18),
                        t.minerConf.realethBurn = new f.default(t.minerConf.ethBurn).dividedBy(Math.pow(10, g)).toFixed(),
